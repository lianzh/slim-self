...
abstract class Debug
{
	 ...
	 */
	public static function html_output($html = 'auto')
	{
     ...
     * @param int $depth
     */
    public static function dump($vars, $label = null, $depth = null)
    {
        $trace = debug_backtrace();
        if ($trace[0]['function'] == 'dump' && $trace[0]['class'] == 'SelfApp\\Helper\\Debug')
        {
            array_shift($trace);
        }
...
EOT;
    ...
    public static function dump_trace()
    {
        ...
        $lines = '';
        $index = 0;
        $t = realpath(SELFAPP_PATH . '/../vendor');
        $l = strlen($t);
     ...
     * @endcode
     */
    public static function dump_exception(\Exception $ex)
    {
